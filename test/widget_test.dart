...
import 'package:stone_provider/main.dart';

void main() {
  testWidgets('Payment app smoke test', (WidgetTester tester) async {
    // Build our app and trigger a frame.
    await tester.pumpWidget(const MaterialApp(home: PaymentApp()));
